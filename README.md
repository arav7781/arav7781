...
```mermaid
flowchart LR
    A["ARAV SAXENA"] --> B["Technical Skills"]
    A --> C["Projects"]
    A --> D["Experience"]
    A --> E["Achievements"]
    A --> F["Education"]
    ...
    B --> B5["Cloud & DevOps"]
    B --> B6["AI / LLM"]
    C --> C1["Global Freight Platform"]
    C --> C2["Decentralized NFT Platform"]
    C --> C3["NL to SQL Analytics"]
    D --> D1["Research Intern - SCAAI"]
    E --> E1["Research Paper & Patents"]
    F --> F1["B.Tech AI & ML - SIT Pune"]
